...
module OpenASNPipeline
  module Fetch
    ...
    KEYS = {
      ...
      wikidata_countries: "wikidata/p17-p159-countries.json"
    }.freeze
    ...
    def run(http: Http.new, offline: ENV["OFFLINE"] == "1")
      ...
      # CC0 per-ASN country (D-SRC-2, country): P17/P159 of the same items.
      paths[:wikidata_countries] = http.fetch(Sources::WIKIDATA_COUNTRIES_URL, KEYS[:wikidata_countries], offline: offline)
